        ...
        <div className=" flex flex-col gap-[3rem] items-center justify-center text-center">
          ...
          <h1 className="text-center text-[4rem] md:text-[5rem] font-bold leading-[1.2]">
            ...
            <span className="relative block min-h-[2.4em] md:min-h-0 md:inline-block md:align-bottom">
              {/* visibility:hidden, not opacity/aria alone — the box must still
                  take up its full width to reserve it, but must paint nothing.
                  Without `invisible` this renders the phrase in the heading's
                  default colour underneath the green typewriter overlay. */}
              <span aria-hidden className="invisible hidden md:inline">
                {LONGEST_WORD}
              </span>
