        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-3 ">
          <div className="pt-4 pb-4">
            ...
            <p className="text-[1.5rem] font-[500] leading-[1.5] tracking-[2]">
              Revolutionary chairs unite science and design for style and comfort. With ergonomic shapes and unique
              materials, they elevate decor and enhance posture. Make a statement with these distinctive pieces in any
              room.
            </p>
          </div>
          <div className="pt-4 pb-4">
            ...
            <p className="text-[1.5rem] font-[500] leading-[1.5] tracking-[2]">
              Selecting the right chair for ultimate reliability is crucial. We offer chairs built to last, enhancing
              daily life with ergonomic features and advanced materials. Don't compromise on comfort – buy from us
              today.
            </p>
          </div>
          <div className="pt-4 pb-4">
            ...
            <p className="text-[1.5rem] font-[500] leading-[1.5] tracking-[2]">
              Chairs, an everyday item, serve various purposes in our lives. Their diverse forms and materials require
              us to consider ethics and long-term consequences when buying.
            </p>
          </div>
        </div>
      </div>
